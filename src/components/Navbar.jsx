    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          >
            <img src="/logo.png" alt="Mark Shears Insurance" className="object-contain transition-all duration-300" style={{ height: scrolled ? '40px' : '56px' }} />
          </motion.a>
