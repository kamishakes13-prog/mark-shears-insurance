...
export default function Navbar() {
  ...
  return (
        <motion.nav
              ...
              >
        </motion.nav>motion.a>h                      <div className="flex items-center justify-between">
                             ...
                             <h href={link.href} className={`font-medium ${scrolled ? 'text-gray-700 hover:text-blue-600' : 'text-white hover:text-blue-300'}`}>{link.name}</a>
                                            ...
                                            <a href="tel:95621h<h href=  <a href=631" className="flex items-center gap-2 bg-primary text-white px-4 py-2 rounded-full font-semibold hover:bg-dark transition-colors">
