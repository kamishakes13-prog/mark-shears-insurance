...
import { FaHeart, FaUserMd, FaPiggyBank, FaChartLine, FaCar, FaHome, FaUmbrella, FaBuilding, FaBriefcase, FaKey } from 'react-icons/fa'
...
const services = [
  ...
  { icon: FaKey, title: 'Renters Insurance', desc: "Protect your personal belongings and get liability coverage — affordable peace of mind for renters.", keyword: 'renters insurance Rio Grande Valley', link: 'https://www.epremiuminsurance.com/DirectToConsumerPartner.aspx?IRISAccountID=bciFI%2b9tX6g%3d&TopLevelIRISAccountID=DKkpwg9hFl8%3d' },
          ...
          <section id="services" className="py-20 bg-blue-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <motion.div
                                    ...
                                    viewport={{ once: true }}
                                  >
                                  <h2 className="section-title">Our Insurance Services</h2>h2>
                        ...
                        <motion.div
                                      ...
                                      <h3 className="font-bold text-dark text-lg mb-2">{service.title}</h3>h3>
                                      <p className="text-gray-600 text-sm leading-relaxed">{service.desc}</p>p>
